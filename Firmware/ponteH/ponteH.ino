...
class DCMotor {
  ...
  void loop() {
    AGV1.ForwardAGV();  // Move o AGV para frente
    delay(10000);  // Aguarda 10 segundos
    AGV1.StopAGV();  // Para o AGV
    delay(5000);  // Aguarda 5 segundos
  
    AGV1.BackwardAGV();  // Move o AGV para trás
    delay(10000);  // Aguarda 10 segundos
    AGV1.StopAGV();  // Para o AGV
    delay(5000);  // Aguarda 5 segundos
  
    AGV1.LeftAGV();  // Vira o AGV para a esquerda
    delay(10000);  // Aguarda 10 segundos
    AGV1.StopAGV();  // Para o AGV
    delay(5000);  // Aguarda 5 segundos
  
    AGV1.RightAGV();  // Vira o AGV para a direita
    delay(10000);  // Aguarda 10 segundos
    AGV1.StopAGV();  // Para o AGV
    delay(5000);  // Aguarda 5 segundos
  }
